# This Makefile is for the Exception::Simple extension to perl.
#
...
MAKE = make
FULLEXT = Exception/Simple
BASEEXT = Simple
PARENT_NAME = Exception
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Exception/Simple.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Exception/Simple.pm
...
TO_INST_PM = lib/Exception/Simple.pm

PM_TO_BLIB = lib/Exception/Simple.pm \
...
manifypods : pure_all  \
	lib/Exception/Simple.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Exception/Simple.pm $(INST_MAN3DIR)/Exception::Simple.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>simple exception class</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Exception/Simple.pm blib/lib/Exception/Simple.pm 
...
upgradedeps ::
	$(PERL) Makefile.PL --config= --upgradedeps=Test::More,0,Test::Exception,0,parent,0,overload,0

upgradedeps_notest ::
	$(PERL) Makefile.PL --config=notest,1 --upgradedeps=Test::More,0,Test::Exception,0,parent,0,overload,0

listdeps ::
	@$(PERL) -le "print for @ARGV" 

listalldeps ::
	@$(PERL) -le "print for @ARGV" Test::More Test::Exception parent overload
